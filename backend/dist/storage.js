...
class MemStorage {
    ...
    createUser(insertUser) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hashedPassword = yield bcrypt.hash(insertUser.password, 10);
            const user = Object.assign(Object.assign({}, insertUser), { firstName: insertUser.firstName || null, lastName: insertUser.lastName || null, password: hashedPassword, // Store hashed password
    ...
    removeProduct(id) {
        return __awaiter(this, void 0, void 0, function* () {
            this.products.delete(id); // Removes the product by ID from the Map
        });
    }
    loginUser(identifier, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = (yield this.getUserByUsername(identifier)) || (yield this.getUserByEmail(identifier));
            if (!user)
                return undefined;
    ...
    createCategory(insertCategory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const category = Object.assign(Object.assign({}, insertCategory), { description: insertCategory.description || '', id });
    ...
    updateOrder(order) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingOrder) {
                this.orders.set(order.id, Object.assign(Object.assign({}, existingOrder), order));
            }
        });
    }
    ...
    createProduct(insertProduct) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const product = Object.assign(Object.assign({}, insertProduct), { originalPrice: insertProduct.originalPrice || null, downloadUrl: insertProduct.downloadUrl || '', rating: insertProduct.rating || "0", reviewCount: insertProduct.reviewCount || 0, downloadCount: insertProduct.downloadCount || 0, tags: insertProduct.tags || [], isFree: insertProduct.isFree || false, isActive: insertProduct.isActive || true, id, createdAt: new Date(), updatedAt: new Date() });
    ...
    checkoutCart(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const cartItems = yield this.getCartItems(userId);
            if (cartItems.length === 0)
                throw new Error("Cart is empty");
            const order = {
                userId,
                totalAmount: cartItems.reduce((sum, item) => sum + parseFloat(item.product.price) * item.quantity, 0).toString(),
                status: "pending",
                paymentMethod: "credit_card", // Default for now
            };
            const newOrder = yield this.createOrder(order);
            for (const cartItem of cartItems) {
                yield this.addOrderItem({
                    orderId: newOrder.id,
                    productId: cartItem.productId,
                    quantity: cartItem.quantity,
                });
            }
            yield this.clearCart(userId); // Clear cart after order
            return newOrder;
        });
    }
}
